...
- [ ] All configurations registered in settings.json
...
**Bundles** are combinations of packs that work exceptionally well together—a harmonious system unified around a single theme. The packs in a bundle were designed to integrate seamlessly, creating emergent capabilities greater than the sum of their parts.
...
|-------------|-------------|---------|
| **Creator Bundle** | All packs from a specific creator | "PAI for Windows" - Complete Windows-native system |
...
| **Starter Bundle** | Minimal set to get started | "PAI Lite" - essential packs only |
...
| Bundle | Description | Platform | Status |
|--------|-------------|----------|--------|
| [PAI for Windows](PAI/) | Complete personal AI infrastructure for Windows 11 + Bun | Windows | Active |

*Windows-native bundle with TypeScript + Bun runtime for cross-platform compatibility*
...
Your AI will:
- **Run the wizard** - If the bundle includes a setup wizard, walk you through configuration
...
1. Run the bundle installation wizard (if available)
2. Install prerequisite packs first
3. Install core packs in listed order
4. Install optional packs as desired
5. Run bundle verification
...
| **Structure** | Directory with README.md, INSTALL.md, VERIFY.md, src/ | Directory with README.md + install script |
...
└── YourBundle/
    ...
    └── install.ts          # Installation wizard (optional)
```
...
- [ ] Follow Windows-native conventions where applicable
...
Absolutely. Fork the repo, create a new directory in Bundles/, and follow the structure.
...
- [PAI for Windows Repository](https://github.com/yourusername/PAI_Windows_v2)
- [Packs Directory](../Packs/)
- [PAI Bundle](PAI/) - Complete Windows implementation

---

*PAI Bundle System v2.0 - Windows-native curated experiences with directory-based packs.*
